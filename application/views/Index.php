        ...
        <div class="container-fluid">
          <div class="animated fadeIn">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="card">
                  <div class="card-header">Total Produksi Roti</div>
                  <div class="card-body">
                    <form class="form-horizontal" action="<?php site_url('Index/index') ?>" method="get" >
...
<script>
    ...
    var chart = new Chart(ctx, {
        ...
        data: {
            ...
            datasets: [{
                label:'Tanggal Total Produksi Roti',
                  ...
                  <div class="card-body pb-0">
                    <div class="btn-group float-right">
                      ...
                      <div class="dropdown-menu dropdown-menu-right">
                        <a class="dropdown-item" >Permintaan :&nbsp 10</a>
