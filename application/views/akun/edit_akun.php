              ...
              <div class="col-md-10">
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <form class="form-horizontal" action="<?php echo site_url('akun/c_akun/edit/'.$user->Id)?>" method="post">
                     <input class="form-control"  type="hidden" name="id" placeholder="Text" value="<?= $user->Id ?>">
