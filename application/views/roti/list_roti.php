              ...
              <div class="col-lg-12">
                <div class="card">
                  <div class="card-header">
                    <i class="fa fa-align-justify"></i> Daftar Roti</div>
                  ...
                  foreach ($produk_roti as $roti){
                    ?>
                          ...
                          <div class="form-group row">
                            <form action="<?php echo site_url('roti/c_roti/delete/'.$roti->Id_roti) ?>" >
                          <fieldset>
                         ...
                         <form action="<?php echo site_url('roti/c_roti/edit/'.$roti->Id_roti) ?>" >
                          <fieldset>
