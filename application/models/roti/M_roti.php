...
*/
   ...
   public function page($number,$offset){
        $this->db->order_by('produk_roti.Nama','desc');
   ...
   public function jumlah_data(){
    ...
    {
        return $this->db->get_where($this->_table, ["Id_roti" => $id])->row();
    }
    ...
    public function update()
    {
        ...
        $this->db->update($this->_table, $this, array('Id_roti' => $post['id']));
    ...
    public function delete($id)
    {
        ...
        return $this->db->delete($this->_table, array("Id_roti" => $id));
	}
	/*
