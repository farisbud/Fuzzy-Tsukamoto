...
class C_akun extends CI_Controller
{
   public function __construct()
    ...
    if($this->session->userdata('Level') !== 'Pemilik' || $this->session->userdata('logged_in') !== TRUE){

      $this->session->set_flashdata('msg', '<div class="alert alert-success" role="alert">anda bukan pemilik, dilarang masuk halaman ini,silahkan login kembali</div>');
